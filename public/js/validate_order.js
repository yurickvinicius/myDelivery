function validateOrder(){
  ...
  ///
  if($('#typeOrder').val() == 'orderIn' || $('#typeOrder').val() == 'orderOut'){
  ...
  ///
  if($('#typeOrder').val() == 'orderIn'){
    if ($('#cadBoard').val() == 0){
      $('div[id=divCadBoard]').addClass('has-error');
      errorValidate = true;
    }else{
      $('div[id=divCadBoard]').removeClass('has-error');
    }
  }
  ///////
